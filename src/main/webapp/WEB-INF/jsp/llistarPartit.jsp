...
<%@ page import="java.util.ArrayList, com.slc.model.bd.Partit"%>
...
<body>
	      
	<h1 style="margin: 15px;">Estadístiques individuals de l'últim partit</h1>
	...
	<table class="table table-striped">
		...
		<%ArrayList<Partit> lista = (ArrayList<Partit>) request.getAttribute("resultQuery");
		if (lista != null) {
		 for (Partit part : lista) {
			out.println("<tr>");
